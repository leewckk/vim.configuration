...
func FunTitle()
    ...
    call append(line(".")+9, "//    1.Date          : ".strftime("%Y-%m-%d %H:%M:%S")) 
    call append(line(".")+10, "//     Author        : liwenchao") 
    call append(line(".")+11, "//     Modification  : Create function.") 
		call append(line(".")+12, "//-->")
    call append(line(".")+13, "")
  endif 
...
"        call setline(1,"<head><meta charset=\"UTF-8\"></head>")
    ...
    call append(line(".")+8, "  *     Author        : liwenchao") 
    call append(line(".")+9, "  *     Modification  : Create file.") 
		call append(line(".")+10, "  **/") 
		call append(line(".")+11, "")
	endif
	if expand("%:e") == 'cpp'
...
map <F6> :cs kill .<CR><CR> :cscope -Rbq .<CR><CR> :cs add cscope.out .<CR><CR> :cs reset<CR>
imap <F6> <ESC>:cs kill .<CR><CR> :cscope -Rbq .<CR><CR> :cs add cscope.out .<CR><CR> :cs reset<CR>
